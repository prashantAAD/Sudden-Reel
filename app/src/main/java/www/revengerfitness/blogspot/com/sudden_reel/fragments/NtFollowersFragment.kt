...
import www.revengerfitness.blogspot.com.sudden_reel.databinding.FragmentNtFollowersBinding
import www.revengerfitness.blogspot.com.sudden_reel.model.NotificationModel



class NtFollowersFragment : Fragment() {


    lateinit var binding: FragmentNtFollowersBinding
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_nt_followers, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        binding= FragmentNtFollowersBinding.bind(view)
        ...
        binding.ntFollowersRecyclerview.layoutManager=layoutManager
        ...
        FirebaseDatabase.getInstance().reference
            ...
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    binding.ntFollowersRecyclerview.adapter=adapter
        ...
        binding.followersNtDelete.setOnClickListener {
            ...
            if (list.size==0){
                ...
                dialogTxt.text="Delete all followers notifications?"
                            ...
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                for (dataSnapshot in snapshot.children){
                                    ...
                                    if (data?.type=="follow"){
                                        ...
                                        FirebaseDatabase.getInstance().reference.child("notification")
                                            .child(FirebaseAuth.getInstance().uid.toString()).child(
                                                data?.notificationId.toString()).removeValue()
