...
import www.revengerfitness.blogspot.com.sudden_reel.databinding.FragmentNtLikesBinding
import www.revengerfitness.blogspot.com.sudden_reel.model.NotificationModel



class NtLikesFragment : Fragment() {

    lateinit var binding: FragmentNtLikesBinding
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_nt_likes, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        binding= FragmentNtLikesBinding.bind(view)
        ...
        binding.ntLikesRecyclerview.layoutManager=layoutManager
        ...
        FirebaseDatabase.getInstance().reference
            ...
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    binding.ntLikesRecyclerview.adapter=adapter
        ...
        binding.LikesNtDelete.setOnClickListener {
